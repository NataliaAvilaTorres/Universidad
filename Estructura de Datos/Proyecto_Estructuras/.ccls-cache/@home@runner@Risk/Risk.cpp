...
void Risk::crearGrafo(list <Continente> continentesR)
{
    list<Pais>todosLosPaises;

    for(list<Continente>::iterator c = continentesR.begin(); c != continentes.end(); c++)
    {
        list<Pais> paises_conti = (*c).getPaises();
